...
class EmployeeUpdateRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('Actualizar Empleados');
    }
    ...
    public function rules()
    {
        return [
            ...
            'identy' => ['required', 'max:13', 'min:13', Rule::unique('employees')->ignore($this->id)],
            'address' => 'max:200',
            'phone_number' => 'required | size:8',
            'employee_code' => ['required', 'max:20', Rule::unique('employees')->ignore($this->id)],
