...
class SalaryRuleUpdateRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('Actualizar Reglas Salariales');
    }
    ...
    {
        return [
            'concept' => 'required', 'max:30', Rule::unique('salary_rules')->ignore($this->id),
